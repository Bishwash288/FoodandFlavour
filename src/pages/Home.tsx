...
import { Mail, Sparkles, Award, Users } from "lucide-react";
    ...
    <div className="flex flex-col bg-background">
      ...
      <section className="relative py-32 bg-muted/50 overflow-hidden">
        <div className="absolute inset-0 z-0">
          ...
          />
          <div className="absolute inset-0 bg-gradient-to-b from-muted/80 via-muted/60 to-muted/80" />
        </div>
